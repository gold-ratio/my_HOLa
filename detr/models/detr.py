...
class DETR(nn.Module):
    ...
    def __init__(self, backbone, transformer, num_classes, num_queries, aux_loss=False, dataset_file = 'hico'):
    ...
    def forward(self, samples: NestedTensor):
        ...
        try:
            ...
            out = {'pred_logits': [], 'pred_boxes': outputs_coord[-1]}
        if self.aux_loss:
...
def build(args):
    ...
    if args.dataset == 'vcoco' and 'e632da11' in args.pretrained:
        num_classes = 91
    elif 'detr-r50-e632da11' in args.pretrained:
        num_classes = 91
